...
class ConfigEditorItem {
  ...
  DivElement makeElement(JavelinConfigVariable value) {
    return null;
  }
}
...
class ConfigSlider extends ConfigEditorItem {
  ...
  DivElement makeElement(JavelinConfigVariable variable) {
    ...
    if (variable.value is num) {
      ...
      e.on.input.add((event) {
        ...
        JavelinConfigStorage.storeVariable(variable.name);
      });
      root.nodes.add(l);
      root.nodes.add(e);
    }
  ...
  void build() {
    ...
    _items.forEach((configitem) {
      ...
      }
      {
        ...
        JavelinConfigVariable variable = JavelinConfigStorage.variables[configitem.name];
